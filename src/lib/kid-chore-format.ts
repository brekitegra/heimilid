...
// math — just typed against KidChore instead of PetCareTask.
...
export function formatKidChoreLastDone(chore: KidChore, now = new Date()): string | null {
...
export function formatKidChoreStreak(chore: KidChore): string | null {
